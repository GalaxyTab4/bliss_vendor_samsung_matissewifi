...
LOCAL_PATH := vendor/samsung/matissewifi
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/proprietary/etc/permissions/android.hardware.consumerir.xml:system/etc/permissions/android.hardware.consumerir.xml \
